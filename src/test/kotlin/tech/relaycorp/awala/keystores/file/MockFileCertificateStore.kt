...
/**
 * Certificate store that claims to encrypt certification path files.
 *
 * But it doesn't actually encrypt anything.
 */
class MockFileCertificateStore(keystoreRoot: FileKeystoreRoot) : FileCertificateStore(keystoreRoot) {
